...
const index = () => {
  ...
  return (
    <div className='flex items-center justify-center gap-6 w-full h-screen'>
     ...
     <form onSubmit={submitLogin} className='flex flex-col text-center justify-center gap-6 '>
     ...
     <label htmlFor="email" className='flex items-center gap-4 px-4 py-2 border-black border-2 rounded-sm'>
      ...
      <button type="submit" className='px-6 py-3 bg-blue-700 rounded-sm text-white font-bold'>Login</button>
     </form>
    </div>
  )
}
